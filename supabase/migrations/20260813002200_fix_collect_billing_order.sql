...
BEGIN
    -- Se o caller for nulo, permitimos a execução se for via service_role ou se for uma correção manual,
    -- mas para segurança padrão validamos o company_id.
    ...
    -- Limpeza de paletes e reservas é crucial após a exclusão do estoque manual
