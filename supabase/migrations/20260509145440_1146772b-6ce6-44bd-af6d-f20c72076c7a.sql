-- Corrigindo a função get_report_data para lidar com p.date sendo TEXT
CREATE OR REPLACE FUNCTION public.get_report_data(
  p_company_id UUID,
  p_start_date TEXT, -- Alterado para TEXT para combinar com public.productions.date
  p_end_date TEXT,   -- Alterado para TEXT
...
DECLARE
  ...
  v_result JSON;
BEGIN
  -- 1. Calcular Totais Gerais para o período e filtros
  SELECT 
