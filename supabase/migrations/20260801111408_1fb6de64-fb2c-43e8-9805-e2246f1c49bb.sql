-- 1) Idempotência do espelhamento de OF -> estoque manual
CREATE UNIQUE INDEX IF NOT EXISTS uq_msm_source_movement
  ON public.manual_stock_movements (source_movement_id)
  WHERE source_movement_id IS NOT NULL;

-- 2) Limpeza do cálculo de saldo (colunas mortas dummy/dummy2/mx_kg)
