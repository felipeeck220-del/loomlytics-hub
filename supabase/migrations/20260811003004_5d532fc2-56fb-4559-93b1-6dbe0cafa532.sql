-- Reset do Estoque Malha (Manual)
-- Removemos todos os movimentos e restauramos apenas as reservas de OFs ativas
-- (separating/ready) para garantir a integridade do saldo reservado.
...
BEGIN
    ...
    -- Buscamos na tabela stock_movements (estoque global) as reservas vinculadas a OFs não finalizadas
    ...
    -- 3. Notificamos sobre a mudança (opcional, dependendo de como o frontend escuta)
