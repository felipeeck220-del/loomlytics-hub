...
BEGIN
  ...
  -- Se for nulo (execução via API/RPC interna sem contexto JWT completo injetado no PostgREST),
  -- ou se não existir no profiles (FK constraint), tentamos buscar pelo author_code se disponível
