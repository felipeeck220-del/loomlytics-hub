-- Corrigindo a RPC para garantir que o zeramento filtre apenas movimentos 'on_machine'
...
BEGIN
    ...
    -- CRITICAL FIX: Explicitly filter by on_machine = true to calculate current machine balance
    SELECT 
    ...
    WHERE company_id = p_company_id
      ...
      AND on_machine = true; -- Filter whole set to machine balance only
