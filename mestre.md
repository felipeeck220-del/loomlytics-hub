...
- **31/03/2026 04:15** — Corrigido PDF em branco: elemento off-screen (`left:-9999px`) não era capturado pelo html2canvas. Alterado para `position:absolute; z-index:-9999` para ficar renderizável.

---

*Última atualização: 31/03/2026 04:15 (Brasília)*
