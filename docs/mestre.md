...
*Última atualização: 10/06/2026 11:30 (Brasília)*
- 10/06/2026 11:30 - Notas Fiscais (Clientes): Adicionados campos de auditoria (usuário e código) na listagem de notas, abaixo da data. Implementado log de auditoria ao criar e excluir notas.
