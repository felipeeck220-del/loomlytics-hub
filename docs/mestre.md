...
*Última atualização: 19/06/2026 00:00 (Brasília)*
- 19/06/2026 00:00 - /billing-orders · Paletes: placeholder do campo Máquina no modal de Paletes alterado de "Selecione a máquina (obrigatório)" para "Selecione a máquina" para evitar overflow no mobile. O asterisco vermelho (*) no label continua indicando obrigatoriedade.
