...
*Última atualização: 10/06/2026 11:20 (Brasília)*
- 10/06/2026 11:20 - Notas Fiscais (Clientes): Corrigida falha de RLS ao usar get_user_company_id() nas políticas. Implementada trava de cliente no seletor de nova nota quando disparado a partir de uma aba específica de cliente.
