- **03/07/2026 (OT — pente fino) — ArticleChangeOrdersTab · Fix perda de foco nos campos de fita:**  estava declarado dentro de  e era recriado a cada render, fazendo os s de LFA/Estiragem/Observação/tipo de fio perderem o foco a cada tecla. Extraído para escopo de módulo recebendo  por prop;  agora memoizadas com . Sem mudança de schema, permissões ou fluxo.
