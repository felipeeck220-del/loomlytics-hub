...
*Última atualização: 10/06/2026 11:10 (Brasília)*
- 10/06/2026 11:10 - Notas Fiscais (Clientes): Refinamento completo das políticas de RLS e logs de depuração no frontend para solucionar definitivamente o erro de permissão ao salvar novas entradas/saídas.
