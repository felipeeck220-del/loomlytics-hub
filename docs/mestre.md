 - **06/07/2026 (OC — admin com acesso total) — /mecanica/oc:** `MaintenanceOrdersTab.canExecuteCorrective` agora inclui `role==="admin"`, permitindo que o admin #1 execute todo o fluxo da OC (iniciar/finalizar), além de já poder criar/cancelar/excluir. Antes só mecânico / líder de mecânica / líder noite podiam iniciar/finalizar. Sem mudança de schema.
