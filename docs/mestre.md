...
*Última atualização: 05/06/2026 15:55 (Brasília)*
- 05/06/2026 15:55 - Relatórios > Pódio: Alterada a métrica principal de ordenação do pódio de "Peso (kg)" para "Eficiência (%)". Esta mudança garante uma competição justa entre os turnos, permitindo que turnos com menor carga horária (como o da Noite) possam vencer baseando-se na produtividade relativa e não apenas no volume absoluto.
