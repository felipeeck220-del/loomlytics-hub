...
*Última atualização: 05/06/2026 16:25 (Brasília)*
- 05/06/2026 16:25 - Relatórios > Pódio: Refinamento visual da exportação PDF. Aumentado o contraste do fundo dos cards, ajustadas as margens internas (padding), tipografia e barras de eficiência para um visual mais robusto e profissional, seguindo o feedback visual do usuário.
