...
*Última atualização: 05/06/2026 16:15 (Brasília)*
- 05/06/2026 16:15 - Relatórios > Pódio: Refinamento visual completo dos cards do pódio (interface e PDF) seguindo a imagem de referência. Adicionados gradientes, sombras "glow", ícones e bordas estilizadas. No PDF, a frase motivacional foi destacada em um container escuro com borda dourada para máximo impacto visual.
