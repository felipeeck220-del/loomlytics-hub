...
>
> 1. **Quem registrou:** `NomeUsuário #Código` (ex: "João #1") em verde (`text-emerald-600`)
> 2. **Data e hora do registro:** `dd/MM/yyyy HH:mm` (ex: "08/05/2026 10:30") em cinza (`text-muted-foreground/70`)
> 3. **Formato padrão unificado:** Minimalista, sem os prefixos "Registrado por:" ou "Em:".
>
