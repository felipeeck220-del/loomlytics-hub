...
import {
  ...
  AlertTriangle, Wrench, RefreshCw, PauseCircle, Hash, UserCircle2, PlayCircle, ChevronDown, ChevronUp,
} from 'lucide-react';
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-7 animate-fade-in">
      ...
      {/* Bloco "Máquinas Paradas" movido para página dedicada /:slug/ordens */}
