...
BEGIN
  ...
  agg3 AS (
    SELECT client_id, article_id, machine_id,
      ...
      exped_kg, exped_rolls,
      machine_kg + GREATEST(0, exped_kg - reserved_kg) AS available_kg,
      machine_rolls + GREATEST(0, exped_rolls - reserved_rolls) AS available_rolls
    FROM exp_calc
  ),
  by_machine AS (
  ...
  per_article AS (
    SELECT a.client_id, a.article_id,
      ...
      SUM(a.machine_kg) + GREATEST(0, SUM(a.exped_kg) - SUM(a.reserved_kg)) AS available_kg,
      SUM(a.machine_rolls) + GREATEST(0, SUM(a.exped_rolls) - SUM(a.reserved_rolls)) AS available_rolls
